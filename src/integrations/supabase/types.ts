  ...
  public: {
    ...
    Views: {
      ...
      v_project_margin_projection: {
        Row: {
          margin_break_point_ratio: number | null
          margin_declining_flag: boolean | null
          org_id: string | null
          project_id: string | null
          projected_margin_at_completion_ratio: number | null
        }
        Relationships: [
          {
            foreignKeyName: "projects_organization_id_fkey"
    ...
    Functions: {
      ...
      is_project_active: {
        Args: { p_is_deleted: boolean; p_status: string }
        Returns: boolean
      }
      is_project_member: {
        Args: { _project_id: string; _user_id: string }
      ...
      rpc_capture_org_economic_snapshots:
        ...
        | { Args: { p_force?: boolean; p_org_id: string }; Returns: Json }
      ...
      rpc_executive_change_feed: { Args: { p_org_id: string }; Returns: Json }
