...
function EdgeCaseRowCard({ row }: { row: EdgeCaseRow }) {
...
export default function DiagnosticsSection({ orgId, session, projects }: DiagnosticsSectionProps) {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      if (orgId) params.p_org_id = orgId;
  ...
  return (
    <>
      ...
      <SystemDiagnosticsPanel orgId={orgId} />
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              disabled={scenarioRunning || !dbAuthOk || !orgId}
            >
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              disabled={edgeRunning || !dbAuthOk || !orgId || !session}
            >
              <Play className="h-4 w-4 mr-1.5" />
          ...
          <>
            ...
            <div className="space-y-2">
              {edgeResult.results.map(row => (
                <EdgeCaseRowCard key={row.scenario} row={row} />
              ))}
            </div>
          </>
        )}
