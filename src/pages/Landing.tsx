  ...
  return <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 w-full bg-background/95 backdrop-blur-sm border-b border-border z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button variant="ghost" onClick={() => navigate('/how-it-works')} className="hidden md:inline-flex">
              How It Works
            </Button>
            <Button variant="ghost" onClick={() => navigate('/auth')} className="hidden sm:inline-flex">
              Sign In
            </Button>
            <Button onClick={handleBookDemo} className="bg-[#FF6B35] hover:bg-[#FF6B35]/90 text-white">
              Book a Demo
            </Button>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button size="lg" onClick={handleBookDemo} className="h-14 px-8 text-lg bg-[#FF6B35] hover:bg-[#FF6B35]/90 text-white">
                  Book a Demo
                </Button>
                <Button size="lg" variant="outline" onClick={handleSeeHowItWorks} className="h-14 px-8 text-lg bg-white/10 text-white border-white/30 hover:bg-white/20">
                  See How It Works
                </Button>
              </div>
            </div>
            <div className="flex justify-center">
              <img alt="FieldSync App Dashboard" className="w-full max-w-lg rounded-lg shadow-2xl" loading="eager" src="/lovable-uploads/4e1b85d6-7eda-4f22-abb7-fb02a677b21c.png" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="solution" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            icon: iconAI
          }].map((feature, index) => <div key={index} className="p-6 bg-card rounded-lg border border-border hover:border-[#FF6B35]/50 transition-colors">
                <img src={feature.icon} alt={feature.title} className="w-16 h-16 mb-4 rounded-lg" loading="lazy" />
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" onClick={handleSeePricing} className="h-14 px-8 text-lg">
              See Pricing
            </Button>
          </div>
        </div>
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            {["Trades show up ready", "Blockers get handled quickly", "Safety stays organized", "Meetings get shorter", "Everyone knows what is needed next", "Projects finish on time"].map((item, index) => <div key={index} className="flex items-start gap-3 p-4 bg-card/80 backdrop-blur-sm rounded-lg">
