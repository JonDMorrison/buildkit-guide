...
export function AIInsightsSection({ showChangeFeed, projectId }: Props) {
  ...
  return (
    <DashboardSection title="Insights" helpText="AI-powered summaries of what changed since the last snapshot. Highlights shifting margins, rising risk scores, and projects that need attention." lazy skeletonHeight="h-48" skeletonCount={columns}>
