...
const formTemplates: Record<string, { title: string; fields: Array<{ name: string; label: string; type: string; required?: boolean }> }> = {
  ...
  "incident_report": {
    ...
    fields: [
      ...
      // WorkSafeBC F7-style fields
      { name: "first_aid_given", label: "First Aid Given?", type: "select", required: true },
      { name: "first_aid_details", label: "First Aid Details", type: "textarea" },
      { name: "medical_attention_required", label: "Medical Attention Required?", type: "select", required: true },
      { name: "lost_time", label: "Lost Time Injury?", type: "select", required: true },
      { name: "body_part_injured", label: "Body Part Injured", type: "select" },
      { name: "injury_type", label: "Type of Injury", type: "select" },
      { name: "injuries", label: "Injury Description", type: "textarea" },
      ...
      { name: "supervisor_notified", label: "Supervisor Notified?", type: "select", required: true },
    ],
  },
  "visitor_log": {
    title: "Visitor Log",
