...
-- Update generate_tasks_from_scope: set planned_hours ONLY, stop writing estimated_hours.
-- estimated_hours is legacy and should be set via UI if needed.
...
-- Add comment documenting the canonical field
